...
export default function UnoGame({ room, myId, error, clearError }) {
  ...
  // - it's my turn AND
  // - I have drawn a card this turn (drawn card exists) OR I am in a chain
  const canPass = isMyTurn && (drawnCardId !== null || chainValue !== null);
  ...
  let turnLabel;
  if (isMyTurn && chainValue !== null) {
    turnLabel = `Your turn — chain ${chainValue}s or pass`;
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        gap: "2rem", padding: "1rem", minHeight: 0,
      }}>
        <UnoDrawPile
      ...
      <div style={{
        ...
        <span style={{
          ...
          fontFamily: "'Exo', sans-serif", letterSpacing: "0.03em",
        }}>
          {turnLabel}
        </span>

        {/* Pass turn — shown when holding a drawn card or mid-chain */}
        {canPass && (
